...
// AutoresizingMask constants for CAMetalLayer
mod autoresizing_mask {
    #[allow(dead_code)]
    pub const WIDTH_SIZABLE: u32 = 1 << 1;
    #[allow(dead_code)]
    pub const HEIGHT_SIZABLE: u32 = 1 << 4;
}
use gpui::{
...
impl MetalRenderer {
        ...
        unsafe {
            ...
            let _: () = msg_send![
                ...
                setAutoresizingMask: autoresizing_mask::WIDTH_SIZABLE
                    | autoresizing_mask::HEIGHT_SIZABLE
            ];
        }
        #[cfg(feature = "runtime_shaders")]
        let library = device
    ...
    fn draw_surfaces(
        ...
        // PaintSurface.image_buffer (CVPixelBuffer) is only available on macOS.
        // Surface rendering (video/camera) is not yet supported on iOS.
        let _ = surfaces;
        true
    }
}
